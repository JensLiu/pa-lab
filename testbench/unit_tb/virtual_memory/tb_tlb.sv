...
module tb_tlb;
  ...
  initial begin : test_seq
    ...
    perm = '0;
    perm.r = 1; perm.w = 1; perm.x = 1; perm.u = 1;
    perm.a = 1; perm.d = 1;
    ...
    if (tlb_if.hit) begin
      $display("[TLB]   NOTA: hit=1, el fill se vio instantáneamente (comportamiento combinacional inesperado)");
    end else begin
