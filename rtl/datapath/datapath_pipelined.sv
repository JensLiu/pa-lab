...
`endif
    ...
    word_t DEBUG_IF_haltHintCounter;
    word_t DEBUG_ID_haltHintCounter;
    word_t DEBUG_EX_haltHintCounter;
    word_t DEBUG_MEM_haltHintCounter;
    word_t DEBUG_WB_haltHintCounter;
    always_ff @(posedge clk) begin
        if (ifHints.shouldHalt) begin
