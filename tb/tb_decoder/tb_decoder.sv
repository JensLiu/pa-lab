...
module tb_decoder;
    ...
    initial begin
        ...
        check_eq("R-ADD: aluUseImm", info.aluUseImm === 1'b0);
        ...
        check_eq("LB: aluUseImm", info.aluUseImm === 1'b1);
        ...
        check_eq("LBU: aluUseImm", info.aluUseImm === 1'b1);
        ...
        check_eq("SB: aluUseImm", info.aluUseImm === 1'b1);
