...
VERILATOR_FLAGS = -CFLAGS -fcoroutines --report-unoptflat $(VERILATOR_UNIQUE_FLAGS) $(VERILATOR_TRACE_FLAGS) $(VERILATOR_BUILD_FLAGS) --timing
PACKAGES = ${RTL_INCLUDES_DIR}/pkg_riscv_instructions.sv ${RTL_INCLUDES_DIR}/pkg_global_defs.sv
...
clean:
	@rm -rf obj_dir $(TOP_MODULE).vcd $(TOP_MODULE).fst
